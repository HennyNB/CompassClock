const vm = new Vue({
    ...
    data() {
        return {
            flag: ['零零零秒', '零零一秒', '零零二秒', '零零三秒', '零零四秒', '零零五秒', '零零六秒', '零零七秒', '零零八秒', '零零九秒', '零零十秒', '零十一秒', '零十二秒', '零十三秒', '零十四秒', '零十五秒', '零十六秒', '零十七秒', '零十八秒', '零十九秒', '零二十秒', '二十一秒', '二十二秒', '二十三秒', '二十四秒', '二十五秒', '二十六秒', '二十七秒', '二十八秒', '二十九秒', '零三十秒', '三十一秒', '三十二秒', '三十三秒', '三十四秒', '三十五秒', '三十六秒', '三十七秒', '三十八秒', '三十九秒', '零四十秒', '四十一秒', '四十二秒', '四十三秒', '四十四秒', '四十五秒', '四十六秒', '四十七秒', '四十八秒', '四十九秒', '零五十秒', '五十一秒', '五十二秒', '五十三秒', '五十四秒', '五十五秒', '五十六秒', '五十七秒', '五十八秒', '五十九秒'],
            flag_minute: ['零零零分', '零零一分', '零零二分', '零零三分', '零零四分', '零零五分', '零零六分', '零零七分', '零零八分', '零零九分', '零零十分', '零十一分', '零十二分', '零十三分', '零十四分', '零十五分', '零十六分', '零十七分', '零十八分', '零十九分', '零二十分', '二十一分', '二十二分', '二十三分', '二十四分', '二十五分', '二十六分', '二十七分', '二十八分', '二十九分', '零三十分', '三十一分', '三十二分', '三十三分', '三十四分', '三十五分', '三十六分', '三十七分', '三十八分', '三十九分', '零四十分', '四十一分', '四十二分', '四十三分', '四十四分', '四十五分', '四十六分', '四十七分', '四十八分', '四十九分', '零五十分', '五十一分', '五十二分', '五十三分', '五十四分', '五十五分', '五十六分', '五十七分', '五十八分', '五十九分'],
            flag_hour: ['十二时', '零一时', '零二时', '零三时', '零四时', '零五时', '零六时', '零七时', '零八时', '零九时', '零十时', '十一时'],
            flag_mouth: [{
                name: '零一月',
                flag: false
            }, {
            ...
            flag_solar: [{
                ...
                name: '惊蛰',
                flag: false,
                msg: '公历3月05－07日交节惊蛰的意思是天气回暖，春雷始鸣，惊醒蛰伏于地下冬眠的昆虫。“惊蛰”标志着仲春卯月的开始。作为全年气温回升最快的节气，我国北方大部分地区平均气温已升至0℃以上。南方沿江江南地区为8℃以上，而西南和华南已达10°C至15℃以上，早已是一派融融春光了，日照时数也有了明显的增加。'
            }, {
                name: '春分',
                flag: false,
                ...
                name: '霜降',
                flag: false,
                msg: '公历10月23－24交节霜降是秋季的最后一个节气，是秋季到冬季的过渡。霜降节气特点是早晚天气较冷、中午则比较热，昼夜温差大，秋燥明显。霜降时节，万物毕成，毕入于戌，阳下入地，阴气始凝。霜降过后，植物渐渐失去生机，大地一片萧索,气温骤降、昼夜温差大。霜降节气后，深秋景象明显，冷空气南下越来越频繁。'
            }, {
                name: '立冬',
                flag: false,
